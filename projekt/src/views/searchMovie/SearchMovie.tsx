  ...
  return (
    <div >
      ...
      debounceTimeout={500}
        ...
        style={{ all:"initial",color: "white",fontFamily:"Arial",width: "200px",margin:"0 auto",display:"block",backgroundColor:"transparent",border:"none",borderBottom: "1px solid blue",textAlign:"center",height:"30px",marginBottom:"20px",marginTop:"20px"}}
      />
      
      {!!movies?.movies.length &&
            movies?.movies.map(movie => (
              <Card style={{margin:"auto",marginBottom:"20px",width:"300px"}}>
        <CardActionArea>
          <CardMedia>
